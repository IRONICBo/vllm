...
n3090_file_path = 'latency_data_3090.csv'

# 读取 CSV 文件
k100_data = pd.read_csv(k100_file_path)
n3090_data = pd.read_csv(n3090_file_path)
...
prompt_lengths_n3090 = n3090_data['prompt_len']
prefill_latencies_n3090 = n3090_data['prefill_latency']
decode_latencies_n3090 = n3090_data['decode_latency']
...
axs[0].plot(prompt_lengths_n3090, prefill_latencies_n3090, label='NV 3090', marker='x', linestyle='-', color='r')
...
axs[1].plot(prompt_lengths_n3090, decode_latencies_n3090, label='NV 3090', marker='x', linestyle='-', color='r')
